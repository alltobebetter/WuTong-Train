...
# -*- coding: utf-8 -*-
"""
V7 训练脚本 - Optuna 调参 + 特征交互 + 4 模型 Stacking
"""
...
try:
    from src.train.train_models_v7 import train
    from src.wutong.config import STAGING_DIR
except ImportError:
    from src_train.train_models_v7 import train
    from wutong.config import STAGING_DIR


def main():
    parser = argparse.ArgumentParser(description="训练 V7 模型")
    parser.add_argument("--version", type=str, default="v7.0.0",
                        help="模型版本号")
