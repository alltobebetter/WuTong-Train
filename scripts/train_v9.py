...
try:
    from src.train.train_models_v9 import train
    from src.wutong.config import STAGING_DIR
except ImportError:
    from src_train.train_models_v9 import train
    from wutong.config import STAGING_DIR


def main():
    parser = argparse.ArgumentParser(description="训练 V9 模型")
    parser.add_argument("--version", type=str, default="v9.0.0",
                        help="模型版本号")
